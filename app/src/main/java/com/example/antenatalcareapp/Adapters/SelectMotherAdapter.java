...
public class SelectMotherAdapter extends RecyclerView.Adapter<SelectMotherAdapter.ViewHolder> implements Filterable {
    ...
    public SelectMotherAdapter(Context context, List<MothersModel> mData) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            date.setOnClickListener(view -> {
                Intent update = new Intent(context, CreateAppointments.class);
