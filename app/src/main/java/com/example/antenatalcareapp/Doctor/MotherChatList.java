...
public class MotherChatList extends AppCompatActivity {
    private Menu action;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mother_chat_list);
        urls = new Urls();
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MotherChatList.this));

        mData = new ArrayList<>();
        adapter = new MotherChatAdapter(MotherChatList.this, mData);
        loadMothers();
